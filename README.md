...
Dashboard interativo para análise e exploração de dados utilizando Python, Pandas e Streamlit
...
Filtragem Dinâmica: Consultas customizadas em qualquer coluna para segmentação de dados.

Data Cleaning: Ferramentas integradas para remoção de duplicatas e tratamento de valores ausentes (fillna).

Análise Estatística: Agrupamentos e agregações (Soma e Média) para análise de métricas por categoria.
